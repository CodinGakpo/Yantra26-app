...
const MiniNavbar = () => {
  ...
  if (isLoading) {
    return (
      <header className="bg-white border-b-2 border-blue-100 shadow-md w-full">
  ...
  return (
    <header className="bg-white/95 backdrop-blur-md border-b-2 border-blue-100 shadow-lg w-full">
